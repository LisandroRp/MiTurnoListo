  ...
  es: {
    ...
    services: {
      ...
      validation: {
        ...
        booking: "Carga precio, duracion en minutos y capacidad. Todos los valores tienen que ser enteros y la capacidad debe ser al menos 1.",
  ...
  en: {
    ...
    services: {
      ...
      validation: {
        ...
        booking: "Add price, duration in minutes and capacity. Every value must be an integer and capacity must be at least 1.",
