...
export const messages = {
  es: {
    ...
    calendar: {
      ...
      blockedDaysDescription: "Bloquea dias completos por feriados, vacaciones o cierres puntuales. Esos dias no van a mostrar horarios disponibles para reservar.",
      ...
      blockedDayInvalid: "Revisa las fechas para continuar.",
      blockedDayPastDate: "No podes bloquear dias pasados ni el dia de hoy.",
      blockedDaysEmpty: "Todavia no hay dias bloqueados.",
      closedDay: "Dia bloqueado",
      ...
      cancellationReasonPlaceholder: "Conta brevemente por que se cancela el turno.",
      cancellationReasonRequired: "Agrega el motivo de cancelacion para continuar.",
    ...
    payments: {
      ...
      currentFilterHint: "Segun los filtros actuales",
      currentPage: "Pagina",
      pageHint: "Pagina actual",
      perPage: "Por pagina",
      perPageHint: "Resultados por pagina",
      paginationSummary: "{from}-{to} de {total}",
      previousPage: "Pagina anterior",
      nextPage: "Pagina siguiente",
    ...
    profile: {
      ...
      superAdminDescription: "Revisa negocios registrados, uso mensual, estado comercial y acciones internas.",
